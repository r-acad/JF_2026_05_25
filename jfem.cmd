...
REM Optional sysimage for near-instant startup.
...
if defined SYSIMG_ARG (
  julia "!SYSIMG_ARG!" --project="!REPO_ROOT!." --threads=auto --startup-file=no "!REPO_ROOT!JFEM_installation\julia_tools\jfem.jl" %*
) else (
