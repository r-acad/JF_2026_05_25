...
REM    The launchers (jfem.cmd, POST\PANDEATOR_APP\RUN_PANDEATOR_WINDOWS.cmd) load it AUTOMATICALLY when
...
if not "%STATUS%"=="0" (
    ...
    if exist "!SYSIMG!" (
        ...
        echo   - POST\PANDEATOR_APP\RUN_PANDEATOR_WINDOWS.cmd  ^(web app^)
    ) else (
